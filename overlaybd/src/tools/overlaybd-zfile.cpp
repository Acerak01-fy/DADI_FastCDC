...
int main(int argc, char **argv) {
    ...
    int fastcdc_min_size = 2;
    int fastcdc_avg_size = 8;
    int fastcdc_max_size = 64;
    ...
    if (use_fastcdc) {
        args.use_fastcdc = true;
        args.fastcdc_min_size = fastcdc_min_size * 1024;
        args.fastcdc_avg_size = fastcdc_avg_size * 1024;
        args.fastcdc_max_size = fastcdc_max_size * 1024;
        printf("FastCDC enabled: min=%dKB, avg=%dKB, max=%dKB\n",
